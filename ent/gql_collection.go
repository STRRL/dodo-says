...
func (i *IdentityQuery) collectField(ctx context.Context, op *graphql.OperationContext, field graphql.CollectedField, path []string, satisfies ...string) error {
...
func newIdentityPaginateArgs(rv map[string]interface{}) *identityPaginateArgs {
